...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-eOJMYsd53ii+scO/bJGFsiCZc+5NDVN2yr8+0RDqr0Ql0h+rP48ckxlpbzKgwra6" crossorigin="anonymous">
    ...
    <body>
        <div class="container bg-secondary text-center">
            <form class="text-center" action="executa_inserir.jsp" method="post">
                <label class="text-light">Descrição: </label><br>
                <input class="text-center" type="text" name="descricao"/><br>
                <label class="text-light">Preço: </label><br>
                <input class="text-center" type="text" name="preco"><br>
                <br>
